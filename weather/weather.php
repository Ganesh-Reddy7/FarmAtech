        ...
        <div class="main-container d-flex">
            <div class="sidebar" id="side_nav">
                ...
                <ul class="list-unstyled px-2">
                    ...
                    <li class=""><a href="weather.php" class="text-decoration-none px-3 py-2 d-block" id="elementsize" style="background:rgb(2,83,2);color:white;"><i class="fas fa-sun-cloud mx-2"></i>Weather</a></li>
            ...
            <div class="content">
                <nav class="navbar navbar-expand-md navbar-light bg-primary py-3">
                  ...
                  <div class="dashboard-content  px-3 pt-4" id="dashboard">
                    <h2 class="fs-5 "><b>weather</b></h2>
                    <div class="weather">
                        <input type="search" list="suggestions" class="weather_search" placeholder="Your City">
                        ...
                        <div class="weather_today">
                            <div class="weather_details">
                                ...
                                <div class="weather_current">
                                    <p class="weather_indicator weather_indicator--humudity"><span class="value">50</span>%</p>
                                    <p class="weather_indicator weather_indicator--wind"><span class="value">west,5</span>m/s</p>
                                    <p class="weather_indicator weather_indicator--pressure"><span class="value">1050</span>hPa</p>
                                </div>
                            </div>
                            <img src="images/cloudy.png" alt="clear sun" class="weather_image">
                            <div class="weather_temperature"><span class="value">+25</span>&deg;C</div>
                        </div>
                        <div class="weather_forecast">
                            <article class="weather_forcast_item">
                                <img src="images/few_clouds.png" alt="clear sun" class="weather_forecast_icon">
                                <h3 class="weather_forecast_day">Thursday</h3>
                                <p class="weather_forecast_temperature"><span class="value">+35</span>&deg;C</p>
                            </article>
                            <article class="weather_forcast_item">
                                <img src="images/cloudy.png" alt="clear sun" class="weather_forecast_icon">
                                <h3 class="weather_forecast_day">Friday</h3>
                                <p class="weather_forecast_temperature"><span class="value">+30</span>&deg;C</p>
                            </article>
                            <article class="weather_forcast_item">
                                <img src="images/clear_sun_icon.png" alt="clear sun" class="weather_forecast_icon">
                                <h3 class="weather_forecast_day">Saturday</h3>
                                <p class="weather_forecast_temperature"><span class="value">+36</span>&deg;C</p>
                            </article>
                            <article class="weather_forcast_item">
                                <img src="images/clear_sun_icon.png" alt="clear sun" class="weather_forecast_icon">
                                <h3 class="weather_forecast_day">Sunday</h3>
                                <p class="weather_forecast_temperature"><span class="value">+35</span>&deg;C</p>
                            </article>
                            <article class="weather_forcast_item">
                                <!--<img src="images/clear_sun_icon.png" alt="clear sun" class="weather_forecast_icon">-->
                                <img src="images/few_clouds.png" alt="clear sun" class="weather_forecast_icon">
                                <h3 class="weather_forecast_day">Monday</h3>
                                <p class="weather_forecast_temperature"><span class="value">+34</span>&deg;C</p>
                            </article>
                        </div>
                    ...
                    <!--Scroll Top button-->
                    <a href="#dashboard" class="scroll-top fas fa-angle-up"></a>
